...
angular.module('App')
  ...
  .controller('Controller', ["$scope", "FIREBASE", "$firebaseObject", "$routeParams", "LIST_ICONS", "$window", "$timeout", function($scope, FIREBASE, $firebaseObject, $routeParams, LIST_ICONS, $window, $timeout) {
